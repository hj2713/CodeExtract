...
Extract and isolate: The waitlist feature

{{#if context}}
Additional context:
1. study all of the source at src/source
2. study the current extracted codebase
3. plan and implement a strategy to isolate the outcome/requirement that was described to you. 
{{/if}}

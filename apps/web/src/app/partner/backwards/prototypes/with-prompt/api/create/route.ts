	...
	const stream = new ReadableStream({
		async start(controller) {
			...
			try {
				...
				const appDir = getAppDir(sanitizedName);
				const sourceDir = getAppSourceDir(sanitizedName);  // src/source (sibling of app/)
				const extractedDir = getAppExtractedDir(sanitizedName);  // src/app/extracted
